...
namespace BaraTIao.Controllers
{
    public class LojasController : Controller
    {
        ...
        public LojasController(BaratiaoContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.lsBairros = _context.Bairros.ToList<Bairro>();
        ...
        public async Task<IActionResult> Create([Bind("Id,RazaoSocial,Endereco")] Loja loja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RazaoSocial,Endereco")] Loja loja)
        {
            if (id != loja.Id)
            {
                return NotFound();
